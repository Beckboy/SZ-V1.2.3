...
public class MyPosterListActivity extends BaseActivity implements View.OnClickListener, DeleteItemCallback {
    ...
    private MyPosterListAdapter<PostDetailEntity> myPosterListAdapter;
    private MyPosterListActivity mContext;
    ...
    protected int setLayoutId() {
        return R.layout.act_my_poster_list;
    }
    ...
    private void initView() {
        mAbar = (ActionBar) findViewById(R.id.ab_my_post_list);
        mAbar.setOnClickListener(mContext);
        mPtrFram = (PtrClassicFrameLayout) findViewById(R.id.ptrClassicFrameLayout_my_post_list);
        mLv = (CommonListView) findViewById(R.id.lv_my_poster_list);
        ...
        myPosterListAdapter = new MyPosterListAdapter<>(mContext, deleteItemCallback);
    ...
    public void getData() {
        ...
        OKHttpNewSocialCircle.getInstance().getPostList(mPageIndex, mPagesize, new RequestCallback<PostDetailListDTO>() {
            @Override
...
//        mTvNoData.setVisibility(visibility);
    ...
    private void deletePoster(final int position) {
        ...
        tvTitle.setText("确认删除该条发言？");
        trueButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                todeletePoster(position);
     ...
     * @param position
     */
    private void todeletePoster(final int position) {
        ...
        OKHttpNewSocialCircle.getInstance().deletePost(id, new RequestCallback<SendPostResultDTO>() {
            ...
            public void onSuccess(SendPostResultDTO response) {
                ToastUtil.getInstance(mContext).setContent("帖子删除成功").setShow();
