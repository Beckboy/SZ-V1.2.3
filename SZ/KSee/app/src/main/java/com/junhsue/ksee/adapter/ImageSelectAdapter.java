...
public class ImageSelectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImageSelectAdapter(Context context, int maxImageCount, int isSelectCount, List<ImageBean> list,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == CAMERA_TYPE) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.item_select_image, parent, false);
        ...
        if (getItemViewType(position)==LAYOUT_TYPE) {
            ...
            if (mList.get(position).isSelect()) {
                ...
                if (mSelectImages == null) {
                    holder.canSelect();
                } else if (mSelectImages.size() + isSelectCount == mMaxImageCount) {
                    holder.cannotSelect();
                } else {
                    holder.canSelect();
                }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View v) {
            if (mOnItemClickListener != null) {
                mOnItemClickListener.onItemClickListener(v,getPosition());
//                mOnItemClickListener.onItemClickListener(v, getAdapterPosition());
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            if (mOnChangeListener != null) {
                mOnChangeListener.OnChangeListener(getPosition(), isChecked);
