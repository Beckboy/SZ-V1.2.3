...
public class PopImageDirAdapter extends RecyclerView.Adapter<PopImageDirAdapter.ImageDirViewHolder> {

    private Context mContext;
    private List<ImageDirBean> mList;
    private OnImageDirItemListener mListener;

    public PopImageDirAdapter(Context context, List<ImageDirBean> list, OnImageDirItemListener listener) {
    ...
    public ImageDirViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ImageDirViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_dir_image,parent,false),mListener);
    }
    ...
    class ImageDirViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mListener != null) {
                mListener.onImageDirItemListener(v, getPosition());
            }
        }
    }
}
