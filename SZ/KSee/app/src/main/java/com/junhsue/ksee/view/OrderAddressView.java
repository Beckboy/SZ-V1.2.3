...
public class OrderAddressView extends FrameLayout {
    ...
    private void initializeView(Context context, AttributeSet attrs) {
        ...
        mTxtTop = (TextView) view.findViewById(R.id.txt_top);
        mTxtBottom = (TextView) view.findViewById(R.id.txt_bottom);
    ...
    public void setAddressInfo(String userName, String phone, String unit) {
        ...
        if (TextUtils.isEmpty(unit)) {
            ...
            mTxtTop.setTextColor(getResources().getColor(R.color.c_gray_8392a0));
        }
    }
    ...
    public void setShowHint(boolean isShow) {
        if (isShow)
            mTxtTop.setVisibility(View.VISIBLE);
        else
            mTxtTop.setVisibility(View.GONE);
    }
    ...
    /**
     * 设置机构/学校未完善情况下点击确认报名后的颜色
     */
    public void setOrgColor(int color) {
        mTxtTop.setTextColor(color);
    }
