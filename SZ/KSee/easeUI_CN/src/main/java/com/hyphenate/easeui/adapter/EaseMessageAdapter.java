...
public class EaseMessageAdapter extends BaseAdapter{
	...
	private EaseChatRow.DelCallback delCallback;
	...
	public EaseMessageAdapter(EaseChatRow.DelCallback delCallback, Context context, String username, int chatType, ListView listView) {
	...
	public void midefyDateSetChanged(EMConversation conversation){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		((EaseChatRow)convertView).setUpView(delCallback,message, position,getCount(), itemClickListener);
