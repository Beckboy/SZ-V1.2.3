...
import com.hyphenate.easeui.EaseContactList;
...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    protected List<ClassGroupChatDetailsEntity> contactList;
    ...
    private Map<String, ClassGroupChatDetailsEntity> contactsMap;
    ...
    protected void setUpView() {
        ...
        contactList = new ArrayList<ClassGroupChatDetailsEntity>();
        getContactList();
        //init list
//        contactListLayout.init(contactsMap);
    ...
    protected void getContactList() {
        ...
        synchronized (this.contactsMap) {
            Iterator<Entry<String, ClassGroupChatDetailsEntity>> iterator = contactsMap.entrySet().iterator();
            List<String> blackList = EMClient.getInstance().contactManager().getBlackListUsernames();
            while (iterator.hasNext()) {
                Entry<String, ClassGroupChatDetailsEntity> entry = iterator.next();
                ...
                if (!entry.getKey().equals("item_new_friends")
                    ...
                    if(!blackList.contains(entry.getKey())){
                        ...
                        ClassGroupChatDetailsEntity user = entry.getValue();
        ...
        // sorting
        Collections.sort(contactList, new Comparator<ClassGroupChatDetailsEntity>() {

            @Override
            public int compare(ClassGroupChatDetailsEntity lhs, ClassGroupChatDetailsEntity rhs) {
                if(lhs.english.equals(rhs.english)){
                    return lhs.nickname.compareTo(rhs.nickname);
                }else{
                    if("#".equals(lhs.english)){
                        return 1;
                    }else if("#".equals(rhs.english)){
                        return -1;
                    }
                    return lhs.english.compareTo(rhs.english);
                }
     ...
     * @param contactsMap
     */
    public void setContactsMap(Map<String, ClassGroupChatDetailsEntity> contactsMap){
