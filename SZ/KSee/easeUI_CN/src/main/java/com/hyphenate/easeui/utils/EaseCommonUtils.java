...
public class EaseCommonUtils {
     ...
     * @param user
     */
    public static void setUserInitialLetter(ClassGroupChatDetailsEntity user) {
        ...
        if (letter.equals(DefaultLetter) && !TextUtils.isEmpty(user.nickname)) {
            letter = new GetInitialLetter().getLetter(user.nickname);
        }
        user.english = letter;
    }
  ...
  public static void showPop(final Activity mContext, PopupWindow mPopWindow, View rootView, final WindowManager.LayoutParams lp){
    //显示PopWindow
  ...
  public static void clipboardManager(Context mContext, TextView v){
    ClipboardManager cmb = (ClipboardManager) mContext.getSystemService(Context.CLIPBOARD_SERVICE);
    cmb.setText(v.getText().toString().trim()); //将内容放入粘贴管理器,在别的地方长按选择"粘贴"即可
  }
