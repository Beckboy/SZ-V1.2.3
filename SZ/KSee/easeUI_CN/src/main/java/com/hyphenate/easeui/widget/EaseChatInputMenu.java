...
public class EaseChatInputMenu extends LinearLayout {
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if(emojiconMenu == null){
            ...
            if(emojiconGroupList == null){
                ...
                emojiconGroupList.add(new EaseEmojiconGroupEntity(R.drawable.emoij_001,  Arrays.asList(EaseDefaultEmojiconDatas.getData())));
                emojiconGroupList.add(EaseDefaultEmojiconDatas_gongdou.getData());
            }
    ...
    protected void processChatMenu() {
        ...
        chatPrimaryMenu.setChatPrimaryMenuListener(new EaseChatPrimaryMenuListener() {
            ...
            @Override
            public void onSendBtnClicked(String content,Object[] user) {
                if (listener != null)
                    listener.onSendMessage(content,user);
            }
    ...
    protected void toggleMore() {
        if (chatExtendMenuContainer.getVisibility() == View.GONE) {
            ...
            if (emojiconMenu.getVisibility() == View.VISIBLE) {
                ...
                EaseCommonUtils.softInputFromWiddow((Activity) context);
            }
        }
    }
    ...
    public interface ChatInputMenuListener {
         ...
         *            message content
         */
        void onSendMessage(String content,Object[] user);
