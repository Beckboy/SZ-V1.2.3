...
public class EaseTitleBar extends RelativeLayout{
    ...
    protected TextView titleView,titleCountView;
    ...
    private void parseStyle(Context context, AttributeSet attrs){
        if(attrs != null){
            ...
            int count = ta.getInt(R.styleable.EaseTitleBar_titleBarTitleCount,0);
            ...
            String leftTitle = ta.getString(R.styleable.EaseTitleBar_titleBarLeftTv);
            if (null != leftTv) {
    ...
    public void setTitle(String title, String count){
        titleView.setText(title);
        titleCountView.setText(""+count);
    }
