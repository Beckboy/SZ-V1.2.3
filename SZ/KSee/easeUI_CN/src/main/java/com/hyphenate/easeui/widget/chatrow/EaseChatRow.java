...
public abstract class EaseChatRow extends LinearLayout {
     ...
     * @param position
     */
    public void setUpView(DelCallback delCallback, EMMessage message, int position, int count,
    ...
    private void setUpBaseView() {
        ...
        View view = findViewById(R.id.buttom);
        if (view != null) {
            if (position == count - 1) {
        ...
        String avatar = message.getStringAttribute(EaseConstant.MESSAGE_ATTR_USER_AVATAR,null);
        String nickname = message.getStringAttribute(EaseConstant.MESSAGE_ATTR_USER_NICKNAME,"匿名");
        if(message.direct() == Direct.SEND){
//            EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
            Glide.with(context).load(avatar).placeholder(R.drawable.icon_head_default_96px).into(userAvatarView);
        }else{
...
//            EaseUserUtils.setUserNick(message.getFrom(), usernickView);
    ...
    public interface DelCallback{
        void delMsgid(String msg_id);
        void revokeMsgid(String msg_id,String nickName);
    }
...
//                            itemClickListener.onUserAvatarLongClick(EMClient.getInstance().getCurrentUser());
                            ...
                            itemClickListener.onUserAvatarLongClick(message.getFrom()+":@"+message.getStringAttribute(EaseConstant.MESSAGE_ATTR_USER_NICKNAME,"匿名"));
                        }
                        return true;
                    }
                    return false;
