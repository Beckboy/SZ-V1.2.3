...
public class LinePagerIndicator extends View implements IPagerIndicator {
    ...
    private void init(Context context) {
        ...
        LinearGradient lg=new LinearGradient(0,0,80,80, Color.RED,Color.YELLOW, Shader.TileMode.MIRROR);
        mPaint.setShader(lg);
        mPaint.setStyle(Paint.Style.FILL);
        mLineHeight = UIUtil.dip2px(context, 6);
        mLineWidth = UIUtil.dip2px(context, 40);
    }
