package com.easefun.polyvsdk.live.adpater;
...
import com.easefun.polyvsdk.live.util.ImageLoaderOptions;
...
import com.easefun.polyvsdk.live.view.CircleImageView;
...
//    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final CircleImageView iv_avatar = PolyvViewHolder.get(convertView, R.id.iv_avatar);
        ...
        switch (message.getChatType()) {
            case PolyvChatMessage.CHATTYPE_RECEIVE:
                if (null != user) {
                    ...
                    ImageLoader.getInstance().displayImage(user.getPic(), iv_avatar, ImageLoaderOptions.option(R.drawable.icon_avatar));
                }
                Log.i("test", "CHATTYPE_RECEIVE");
                break;
            //公告 收不到管理员信息
            case PolyvChatMessage.CHATTYPE_RECEIVE_NOTICE:
                tv_notice.setText("");
                //tv_notice.setText(message.getValues()[0]);
                Log.i("test", "CHATTYPE_RECEIVE_NOTICE");
                break;
